...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#180A0A] text-gray-300  ">
      <div>
      ...
      <ul
        className={
          !nav
            ? "hidden"
            : "absolute top-0 left-0 w-full h-screen bg-[#180A0A] flex flex-col justify-center items-center"
        }
      >
        ...
        <ul>
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-600 rounded-[12px]">
            <a
              ...
              href="https://www.linkedin.com/in/shakhawath-hossain-shatu-a5114117b/"
            >
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#17181c] rounded-[12px]">
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="https://github.com/Shakhawathh?tab=repositories"
            >
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#1FC4Da] rounded-[12px]">
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="mailto:shakhawathh55@gmail.com"
            >
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#244D61] rounded-[12px]">
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="https://drive.google.com/file/d/1AbOlOyPmG-siE4g-3emIutdO-RcG23R4/view?usp=drive_link"
              target={"_blank"}
            >
